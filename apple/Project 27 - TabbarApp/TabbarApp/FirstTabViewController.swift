...
class FirstTabViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var data = [
        ...
        article(avatarImage: "allen", sharedName: "张三丰", actionType: "Read Later", articleTitle: "太极功夫变幻莫测，谁也猜不透！", articleCoverImage: "giphy", articleSouce: "TheNextWeb", articleTime: "5min  •  13:20"),
